...
# Mini-project - Long-term dense motion estimation for video editing using FlowNet
...
_Note_ : FlowNetS BN took longer to train and got worse results. It is strongly advised not to you use it for Flying Chairs dataset.
